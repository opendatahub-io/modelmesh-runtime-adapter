...
// UnimplementedModelRuntimeServer must be embedded to have
...
func (UnimplementedModelRuntimeServer) testEmbeddedByValue()                      {}
...
func RegisterModelRuntimeServer(s grpc.ServiceRegistrar, srv ModelRuntimeServer) {
	// If the following call pancis, it indicates UnimplementedModelRuntimeServer was
