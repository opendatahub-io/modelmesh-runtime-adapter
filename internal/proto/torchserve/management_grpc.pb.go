...
// UnimplementedManagementAPIsServiceServer must be embedded to have
...
func (UnimplementedManagementAPIsServiceServer) testEmbeddedByValue()                               {}
...
func RegisterManagementAPIsServiceServer(s grpc.ServiceRegistrar, srv ManagementAPIsServiceServer) {
	// If the following call pancis, it indicates UnimplementedManagementAPIsServiceServer was
